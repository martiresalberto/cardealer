                    ...
                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="vehicul-detail">
                                                ...
                                                <div class="detail-field row">
                                                    ...
                                                    <span class="col-xs-6 col-md-7 detail-field-value">
                                                        <span class="amount">{{ $carros->modelo->nombre }}</span>
                                                    </span>

                                                    <span class="col-xs-6 col-md-5 detail-field-label">Categoria</span>
                                                    <span class="col-xs-6 col-md-7 detail-field-value">
                                                        <span class="amount">{{ $carros->category->nombre }}</span>
                                                    </span>

                                                    <span class="col-xs-6 col-md-5 detail-field-label">Ubicacion</span>
                                                    <span class="col-xs-6 col-md-7 detail-field-value">
                                                        <span class="amount">{{ $carros->ubicacion->nombre }}</span>
                                                    </span>
                        ...
                        <aside class="col-md-4 column">
                            <div class="vehicul-video">
                                <video autoplay muted loop src="{{ asset('storage/video/' . $carros->videos->urlVideo) }}" width="370" height="280"></video>
                            </div>
