          ...
          <tbody>
            ...
            @foreach($condicions as $con)
              <tr>
                ...
                <td>
                  <button class="btn btn-info" data-mytitulo="{{$con->titulo}}" data-conid={{$con->id}} data-toggle="modal" data-target="#editCondicion">Edit</button>
                </td>
                <td>  
                  <button class="btn btn-danger" data-catid={{$con->id}} data-toggle="modal" data-target="#deleteCondicion">Delete</button>
                </td>
              </tr>
