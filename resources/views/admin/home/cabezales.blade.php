...
<div class="">
    <div class="box">
      ...
      <div class="box-header">
        <h1 class="box-title" style="font-family: 'Anton', sans-serif;">Cabezales publicados</h1>
      </div>
      </center> 
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">{{ $predio->titulo }}</h4>
        </div>
          ...
          <div class="modal-body">
            ...
            <div class="col-md-6">
                  <img src="{{ asset('storage/predio/thumbnail/'.$predio->files[0]->url) }}" height="250px" alt="">
            </div>
